...
CREATE TABLE IF NOT EXISTS public.products (
    id UUID PRIMARY KEY DEFAULT gen_random_policy_v4(),
    title TEXT NOT NULL,
    brand TEXT NOT NULL,
...
-- Index for category and full-text search
...
-- Policy for uploading images (public/anon insert allowed for admin demo or service role)
